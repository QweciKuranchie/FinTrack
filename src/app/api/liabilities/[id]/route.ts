  ...
  try {
    ...
    const updatedLiability = await prisma.liability.update({
      ...
      data: {
        ...
        interestPeriod: json.interestPeriod ?? existingLiability.interestPeriod,
        lateFee: json.lateFee !== undefined ? (json.lateFee ? new Prisma.Decimal(json.lateFee) : null) : existingLiability.lateFee,
